...
const PaymentScreen = ({ navigation }) => {
    ...
    try {
      ...
      const params = {
        ...
        discountamount: urlParams.get("discountamount")
          ? Number(urlParams.get("discountamount"))
          : undefined,
  ...
  const handleNavigationStateChange = (navState) => {
    try {
      ...
      Alert.alert(
        "Lỗi",
        "Đã có lỗi xảy ra khi xử lý redirect: " + error.message
      );
      resetState();
    }
  };
    ...
    (function() {
      try {
        ...
        if (mainContent) {
          ...
          mainContent.style.width = '100%';TT
            ...
            onError={({ nativeEvent }) => {
              ...
              Alert.alert(
                ...
                "Không thể tải trang thanh toán: " +
                  (nativeEvent.description || "Không xác định")
              );
              resetState();
            }}
